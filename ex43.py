...
class Game(object):
	...
	def central_corridor(self):
		...
		if action == "shoot!":
			...
			print "you are dead. Then he aets you."
			return 'death'
			...
			print "The Gothon stops, tries not to laught, then busts out laughing and can't move."
	...
	def the_bridge(self):
		...
		print "undef your arm and surprise 5 Gothons who are trying to"
		...
		if action == "throw the bomb":
			...
			print "Gothon soots you right in the back killing you."
	...
	def escape_pod(self):
		...
		if int(guess) != good_pod or guess != 'cheat':
